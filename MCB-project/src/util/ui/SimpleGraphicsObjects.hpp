...
public:
    ...
    bool needsRedrawn() final {
        return !(prevThickness==thickness&&prevX1==x1&&prevY1==y1&&prevX2==x2&&prevY2==y2&&prevColor==color&&hasDrawn);
    }

    uint16_t thickness, x1, y1, x2, y2=0; //can set this directly, will appear next time drawn
