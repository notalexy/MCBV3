...
#include "OdometryControllerConstants.hpp"

namespace subsystems {
OdometryController::OdometryController() {}

float OdometryController::calculate(float currentPosition, float currentVelocity, float currentDrivetrainVelocity, float targetPosition, float inputVelocity, float deltaT) {
...
void OdometryController::estimateState(float* theta, float* thetadot, float tLast, float drivetrainVelocity) {
...
float OdometryController::decelProfile(float poserror, float thetadot, float thetadotinput, float drivetrainVelocity) {
